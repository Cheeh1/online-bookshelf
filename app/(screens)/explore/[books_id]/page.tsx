  ...
  return (
    <>
      <main className="relative flex flex-col md:flex-row xl:flex-row gap-10 xl:gap-20 pt-36 pb-20 items-center xl:px-40 xl:items-start">
        <Link href="/explore">
          <FaArrowLeft className="z-10 absolute top-28 text-3xl text-white left-20 rounded-2xl bg-secondary p-1" />
        </Link>
        <Image
        ...
        <section className="z-10 flex flex-col gap-5">
          <Image
            ...
            alt="book-1"
          />
          <button className="bg-secondary rounded-3xl text-white font-bold py-2 px-4 text-sm tracking-widest">
            Add to library
          </button>
        ...
        <section className="flex flex-col gap-5">
          <div className="flex flex-col text-center xl:text-left md:text-left">
            ...
            <p className="text-sm text-[#A6A6A6] font-bold">Danielle Lori</p>
          </div>
